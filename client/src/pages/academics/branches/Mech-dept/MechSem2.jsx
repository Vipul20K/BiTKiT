        ...
        <>
            ...
            <div className='min-h-screen text-center md:w-[1000px] mx-auto'>
                ...
                <div className='dark:bg-slate-900 text-black'>
                    ...
                    {/* ✅ Mathematics-2 with nested accordions */}
                        ...
                        <div className="collapse-content space-y-2">
                            ...
                            <div className="text-left p-4">
                                <ul className="list-disc space-y-4 ml-5 text-justify">
                                    ...
                                    <li>
                                        <strong>MODULE – I : Ordinary Differential Equations – I </strong><br />
                                        ...
                                        method, Euler – Cauchy’s form of linear differential equation, Method of variation of
                                        parameters.
                                    </li>

                                    <li>
                                        <strong>MODULE – II : Ordinary Differential Equations – II</strong><br />
                                        Ordinary and singular points of differential equation, Power and Frobenius’ series solutions
                                        (root differ by non integer and equal roots). Bessel’s differential equation, Bessel function of
                                        first kind and its important properties. Legendre’s differential equation, Legendre’s polynomial
                                        and its important properties.
                                    </li>

                                    <li>
                                        <strong>MODULE – III : Fourier series and Partial Differential Equations </strong><br />
                                        Fourier series: Euler formulae for Fourier series, Half range Fourier series.
                                        Partial Differential Equations: Method of separation of variables and its application in solving
                                        one dimensional wave and heat equations.
                                    </li>

                                    <li>
                                        <strong>MODULE – IV : Complex Variable-Differentiation & Integration</strong><br />
                                        Function of a complex variable,  Analyticity, Analytic functions, Cauchy – Riemann equations.
                                    ...
                                    <li>
                                        <strong>MODULE – V : Applied Probability </strong><br />
                                        Discrete and continuous random variables, cumulative distribution function, probability mass
                                        and density functions, expectation, variance. Introduction to Binomial, Poisson and Normal
                                        Distribution.
                                    </li>
                                ...
                                <div className="mt-2 px-4">
                                    ...
                                    <ul className="list-none space-y-2 ml-1">
                                        <li>
                                            <a
                                                href="https://youtube.com/playlist?list=PLU6SqdYcYsfKqa52m3wyMZb1KVWuZsA2T&si=xemZuyys5Mh3OXF1"
                                                target="_blank"
                                                rel="noreferrer"
                                                className="flex items-center gap-2 text-red-600 hover:underline"
                                            >
                                                <i className="ri-youtube-fill"></i>
                                                <b>Engineering Mathematics-II - Gajendra Purohit </b>
                                            </a>
                                        </li>
                                        <li>
                                            <a
                                                href="https://youtube.com/playlist?list=PL0s3O6GgLL5fuL7Rh49b2sj3e5Ji9tsY5&si=pilQJYAnRZxwiufU"
                                                target="_blank"
                                                rel="noreferrer"
                                                className="flex items-center gap-2 text-red-600 hover:underline"
                                            >
                                                <i className="ri-youtube-fill"></i>
                                                <b>Engineering Mathematics-II - Last Moment Tuitions </b>
                                            </a>
                                        </li>
                                        <li>
                                            <a
                                                href="https://youtube.com/playlist?list=PLdM-WZokR4tbFEajQEZxKykGKsWGJsICS&si=y4w8EtV1E5-SBSSB"
                                                target="_blank"
                                                rel="noreferrer"
                                                className="flex items-center gap-2 text-red-600 hover:underline"
                                            >
                                                <i className="ri-youtube-fill"></i>
                                                <b>Mathematics-II - Bhagwan Singh Vishwakarma(Playlist-1)</b>
                                            </a>
                                        </li>
                                        <li>
                                            <a
                                                href="https://youtube.com/playlist?list=PLdM-WZokR4tacn5ZYq7BUMPtSXXk4Jyk3&si=fHlNpF2XW_G4nG93"
                                                target="_blank"
                                                rel="noreferrer"
                                                className="flex items-center gap-2 text-red-600 hover:underline"
                                            >
                                                <i className="ri-youtube-fill"></i>
                                                <b>Mathematics-II - Bhagwan Singh Vishwakarma(Playlist-2)</b>
                                            </a>
                                        </li>
                                    </ul>
                                    <hr></hr>
                                    ...
                                    <ul className="list-none space-y-2 ml-1">
                                        <li>
                                            <a
                                                href="https://drive.google.com/file/d/1Y4MhIbiQIM0w9O13wmwBG--j0vl-dF8T/view?usp=sharing"
                                                target="_blank"
                                                rel="noreferrer"
